  ...
  private get _footer(): TemplateResult {
    return html`
      <footer>
        <div class="left">
          <span class="big-type"
            ><a
              rel="noopener"
              target="_blank"
              href="https://www.google.fr/maps/dir//Dobrunia+design/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x12cddbba95967955:0x9af320f68ee988ce?sa=X&ved=2ahUKEwjwwqmtov7dAhVFJBoKHcAJB60Q9RcwEnoECAcQEw"
              >Concept store - 9 Rue Miron, 06000 Nice</a
            ></span
          >
          <span class="middle-type"
            ><a href="mailto:info@dobruniadesign.com"
              >info@dobruniadesign.com</a
            ></span
          >
          <span class="low-type"
            >&copy; ${new Date().getFullYear()} Dobrunia Design. - Tous droits
            réservés.
        ...
        <div class="instagram">
          ${this.socialThumbs && this.socialThumbs.length > 0
            ? html`
                <div class="pics">
                  ${repeat(
                    this.socialThumbs,
                    (thumb) => html`
                      <a
                        target="_blank"
                        href="https://instagram.com/p/${thumb.shortcode}"
                        rel="noopener"
                      >
