...
import crayon, { Router, RouterEventType } from 'crayon';
...
export class ElaraApp extends Root implements Elara.Root {
	...
	public constructor(){
		...
		this._subscriptions.add(this.router.events.subscribe(event => {
			if (event.type === RouterEventType.SameRouteAbort) {
