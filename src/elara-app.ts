		...
		return html`
			...
			<footer>
				...
				<div class="right">
					<h4>Nous suivre</h4>
					<div class="icons">
						<a aria-label="Facebook" title="Facebook" href="https://www.facebook.com/dobruniadesign/" target="_blank" rel="noopener">
						...
						<a aria-label="Instagram" title="Instagram" href="https://www.instagram.com/dobruniadesign/" target="_blank" rel="noopener">
							${this.instagramLogo}
						</a>
						<a aria-label="Etsy" title="Etsy" href="https://www.etsy.com/fr/shop/DobruniaDesign" target="_blank" rel="noopener">
