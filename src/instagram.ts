...
export function instaLoad$(): Observable<ReadonlyArray<InstagramThumbs>>{
    return fromFetch('https://www.instagram.com/graphql/query/?query_id=17888483320059182&query_hash=472f257a40c653c64c666ce877d59d2b&variables=%7B%22id%22:%228130742951%22,%22first%22:%2212%22%7D', {
        headers: {
